<?php
	...
	$lang = array(
		...
		"blacklist_notext" => "Vous devez entrer un Steam64 ou SteamID valide pour l'ajouter à la blacklist.",
		...
		"blacklisted_them" => "Cette personne est sur la blacklist, vous ne pouvez pas lui acheter ceci.",

		"recent_donators" => "Donateurs récents",
		"name" => "Nom",
		"recent_none" => "Il n'y a pas encore de donateur",
		...
		"top_none" => "Il n'y a pas encore de donateur",
	);
